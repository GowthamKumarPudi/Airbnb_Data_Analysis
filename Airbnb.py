...
image= Image.open(r"T:\airbnb-logo-2x.d395ba7f409ea36c6726c876dd3d068ba8743401.png")
st.image(image, width = 350)
st.title("AIRBNB DATA ANALYSIS")
st.write("")

def datafr():
    df= pd.read_csv("T:\Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("T:\AirBnB-Aktienanalyse.jpg")
    st.image(image1)
    ...
    st.write("")
    image2= Image.open(r"T:\te-kahu-wanaka-new-zealand.jpg")
    st.image(image2)
    ...
    st.write("")
    image3= Image.open(r"T:\airbnb-logo.jpg")
    st.image(image3)
